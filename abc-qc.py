...
for js_changed_file in js_changed_files:
    ...
    git_diff_changed_line_lst = [git_diff_file_detail for git_diff_file_detail in git_diff_file_details.split("\n") if re.findall(r'@@.*[+]([0-9]*)[,]*([0-9]*)\s*@@', git_diff_file_detail)]
    lines_changed = set()
